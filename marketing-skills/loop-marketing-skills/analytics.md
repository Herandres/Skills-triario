...
## Fuentes de datos — jerarquía el equipo de marketing digital
...
### Tipos de conversión en el equipo de marketing digital
...
## Eventos esenciales — el equipo de marketing digital
...
| Parámetro | Propósito | Ejemplo el equipo de marketing digital |
|-----------|-----------|----------------------|
...
| utm_campaign | Nombre de campaña | loop_lanzamiento_q2, always_on_search |
...
### Convenciones para el equipo de marketing digital
- Todo en minúsculas con guión bajo
- Incluir el sprint en el nombre de campaña cuando sea relevante: `loop_sprint8_hipotesis_cpl`
...
| Herramienta | Rol en el equipo de marketing digital | Prioridad |
|-------------|----------------------|-----------|
