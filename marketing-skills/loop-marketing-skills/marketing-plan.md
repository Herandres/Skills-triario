...
- **Construcción de OKRs trimestrales**: construir la proyección de resultados con los que el equipo se compromete frente al cliente — objetivos y KPIs duros del trimestre.
- **Construcción de planes de campaña trimestrales**: definir la ruta de acciones, prioridades y estrategia a desplegar a través de lanzamientos por sprint durante el trimestre.

**Human in the loop**: los OKRs y el plan trimestral requieren aprobación del Estratega ejecutivo y del cliente antes de comprometerse. Son documentos de alto impacto en la relación comercial.
