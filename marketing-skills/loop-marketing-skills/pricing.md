...
Esta skill es un recurso de apoyo general para el equipo el equipo de marketing digital de . Aplica cuando el cliente necesita estructurar o comunicar mejor su propuesta de precio como parte de la estrategia de lanzamiento — pricing de servicios, paquetes, anclas de precio o presentación de valor en activos del sprint.

**Human in the loop**: cualquier recomendación de pricing se presenta como propuesta al cliente. La decisión final la toma el cliente.
