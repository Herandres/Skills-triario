...
Esta skill es un recurso de apoyo general para el equipo el equipo de marketing digital de . Aplica cuando el sprint incluye identificación y calificación de prospectos como parte de la estrategia de adquisición — construcción de listas, criterios de calificación o priorización de cuentas target para el ICP del cliente.

**Human in the loop**: las listas de prospección requieren validación del equipo comercial del cliente antes de activarse.
