...
- **Análisis de competencia y definición de ICP**: analizar competidores, presencia digital, mensajes, canales, contenidos, SEO/AEO y ofertas visibles del mercado. Identificar las oportunidades digitales que guiarán los próximos lanzamientos del cliente.

**Human in the loop**: el análisis competitivo es insumo estratégico — el Estratega ejecutivo valida las conclusiones antes de incluirlas en la estrategia Go To Market del cliente.
